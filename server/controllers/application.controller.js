...
export const getAppliedJobs = async (req,res) => {
    try {
        ...
        const userId = req.id;
            // Find all applications for the user, sorted by creation date in descending order
...
export const getApplicants = async (req,res) => {
    try {
        ...
        const jobId = req.params.id;
            ...
            // Find the job by ID and populate the applications and applicant fields
        ...
        if(!job){
            ...
            // Return a success response with the job and its applicants
        return res.status(200).json({
            job,
            success:true
        });
